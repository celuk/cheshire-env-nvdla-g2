        ...
        switch $board {
            genesys2 {
                set_property -dict [list \
                    ...
                    CONFIG.CLKOUT1_JITTER {295.222} \
                    CONFIG.CLKOUT1_PHASE_ERROR {203.230} \
                    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {18.000} \
                    CONFIG.CLKOUT2_JITTER {245.308} \
                    CONFIG.CLKOUT2_PHASE_ERROR {203.230} \
                    CONFIG.CLKOUT3_JITTER {289.461} \
                    CONFIG.CLKOUT3_PHASE_ERROR {203.230} \
                    CONFIG.CLKOUT4_JITTER {329.273} \
                    CONFIG.CLKOUT4_PHASE_ERROR {203.230} \
                    CONFIG.MMCM_CLKFBOUT_MULT_F {18.000} \
                    CONFIG.MMCM_CLKOUT0_DIVIDE_F {40.000} \
                    CONFIG.MMCM_CLKOUT1_DIVIDE {15} \
                    CONFIG.MMCM_CLKOUT2_DIVIDE {36} \
                    CONFIG.MMCM_CLKOUT3_DIVIDE {72} \
