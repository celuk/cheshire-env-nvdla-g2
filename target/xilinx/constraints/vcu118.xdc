...
# sys_clk is the DDR4 reference feeding the MIG MMCM, which is pinned near the
# DDR4 banks in a different clock region than the input pin; allow non-dedicated
# routing so the reference can reach it.
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_bufds_sys_clk/O]

# SoC clock is generated by the DRAM controller (addn_ui_clkout1)
#set SOC_TCK 20.0
