...
`endif
  ...
  `ifdef TARGET_VCU108
    ...
    if (UseDdr4_1 == 1'b1) begin : gen_vcu108_ddr4
      assign soc_clk = soc_clk_i;
    end else begin : gen_vcu108_no_ddr4
      assign soc_clk = dram_clk_o;
    end
