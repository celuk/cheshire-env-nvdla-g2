...
#(
  ...
  function automatic riscv::xlen_t repData64(
      input riscv::xlen_t data, input logic [riscv::XLEN_ALIGN_BYTES-1:0] offset,
  ...
  logic is_nc_miss;
  logic is_ni;
  assign miss_tag = miss_paddr_o[ariane_pkg::DCACHE_INDEX_WIDTH+:DCACHE_TAG_WIDTH];
  assign is_nc_miss = !config_pkg::is_inside_cacheable_regions(
      CVA6Cfg,
      {
        {64 - DCACHE_TAG_WIDTH - ariane_pkg::DCACHE_INDEX_WIDTH{1'b0}},
        miss_tag,
  ...
  assign extract_tag = rd_paddr >> ariane_pkg::DCACHE_INDEX_WIDTH;
  ...
  assign rd_idx_o = rd_paddr[ariane_pkg::DCACHE_INDEX_WIDTH-1:DCACHE_OFFSET_WIDTH];
  ...
  assign wr_idx_o = wr_paddr[ariane_pkg::DCACHE_INDEX_WIDTH-1:DCACHE_OFFSET_WIDTH];
  ...
  for (genvar k = 0; k < DCACHE_WBUF_DEPTH; k++) begin : gen_flags
    ...
    assign wbuffer_hit_oh[k] = valid[k] & (wbuffer_q[k].wtag == {req_port_i.address_tag, req_port_i.address_index[ariane_pkg::DCACHE_INDEX_WIDTH-1:riscv::XLEN_ALIGN_BYTES]});

    // checks if an invalidation/cache refill hits a particular word
    // note: an invalidation can hit multiple words!
    // need to respect previous cycle, too, since we add a cycle of latency to the rd_hit_oh_i signal...
    assign wtag_comp[k] = wbuffer_q[k].wtag[ariane_pkg::DCACHE_INDEX_WIDTH-riscv::XLEN_ALIGN_BYTES-1:DCACHE_OFFSET_WIDTH-riscv::XLEN_ALIGN_BYTES];
    ...
    if (req_port_i.data_req && rdy) begin
      ...
      if (!ni_conflict) begin  //empty of NI operations
        ...
        wbuffer_d[wr_ptr].wtag = {
          req_port_i.address_tag,
          req_port_i.address_index[ariane_pkg::DCACHE_INDEX_WIDTH-1:riscv::XLEN_ALIGN_BYTES]
        };
