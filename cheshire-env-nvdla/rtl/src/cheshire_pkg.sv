...
package cheshire_pkg;
  ...
  localparam cheshire_cfg_t DefaultCfg = '{
    ...
    AxiMstIdWidth     : 8,
    AxiMaxMstTrans    : `ifdef GENESYS2 24 `elsif VCU118 24 `else 1 `endif,
    AxiMaxSlvTrans    : `ifdef GENESYS2 24 `elsif VCU118 24 `else 1 `endif,
    AxiUserAmoMsb     : 1, // Convention: lower AMO bits for cores, MSB for serial link
    AxiUserAmoLsb     : 0, // Convention: lower AMO bits for cores, MSB for serial link
    AxiUserErrBits    : 0,
    AxiUserErrLsb     : 0,
    AxiUserDefault    : 0,
    RegMaxReadTxns    : `ifdef GENESYS2 8 `elsif VCU118 8 `else 1 `endif,
    RegMaxWriteTxns   : `ifdef GENESYS2 8 `elsif VCU118 8 `else 1 `endif,
    RegAmoNumCuts     : 1,
    RegAmoPostCut     : 1,
    RegAdaptMemCut    : 1,
    // RTC
    ...
    DbgMaxReqs        : `ifdef GENESYS2 4 `elsif VCU118 4 `else 1 `endif,
    DbgMaxReadTxns    : `ifdef GENESYS2 4 `elsif VCU118 4 `else 1 `endif,
    DbgMaxWriteTxns   : `ifdef GENESYS2 4 `elsif VCU118 4 `else 1 `endif,
    DbgAmoNumCuts     : 1,
    DbgAmoPostCut     : 1,
    ...
    LlcNumLines       : 256,
    LlcNumBlocks      : 8,
    LlcMaxReadTxns    : `ifdef GENESYS2 16 `elsif VCU118 16 `else 1 `endif,
    LlcMaxWriteTxns   : `ifdef GENESYS2 16 `elsif VCU118 16 `else 1 `endif,
    LlcAmoNumCuts     : 1,
    LlcAmoPostCut     : 1,
    LlcOutConnect     : 1,
